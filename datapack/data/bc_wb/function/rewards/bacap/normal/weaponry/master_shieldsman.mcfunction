execute in minecraft:overworld run worldborder add 29.0 153
execute in minecraft:the_nether run worldborder add 29.0 153
execute in minecraft:the_end run worldborder add 29.0 153
scoreboard players set blazeandcave:weaponry/master_shieldsman wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 153t
