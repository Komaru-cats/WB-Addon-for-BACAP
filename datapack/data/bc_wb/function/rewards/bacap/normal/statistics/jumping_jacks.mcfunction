execute in minecraft:overworld run worldborder add 66.0 213
execute in minecraft:the_nether run worldborder add 66.0 213
execute in minecraft:the_end run worldborder add 66.0 213
scoreboard players set blazeandcave:statistics/jumping_jacks wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 213t
