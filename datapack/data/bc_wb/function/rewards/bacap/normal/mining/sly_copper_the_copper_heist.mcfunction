execute in minecraft:overworld run worldborder add 88.0 239
execute in minecraft:the_nether run worldborder add 88.0 239
execute in minecraft:the_end run worldborder add 88.0 239
scoreboard players set blazeandcave:mining/sly_copper_the_copper_heist wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 239t
