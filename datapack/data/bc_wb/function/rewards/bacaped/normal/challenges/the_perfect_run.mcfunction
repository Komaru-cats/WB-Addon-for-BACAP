execute in minecraft:overworld run worldborder add 225.0 349
execute in minecraft:the_nether run worldborder add 225.0 349
execute in minecraft:the_end run worldborder add 225.0 349
scoreboard players set blazeandcave:challenges/the_perfect_run wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 349t
