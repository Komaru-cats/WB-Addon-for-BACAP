...
tellraw @a {"text": " +0.5 Blocks", "color": "#B2FFEE", "hover_event": {"action": "show_text", "value": [{"translate": "Unwanted Passenger", "color": "#75E1FF"}, {"text": "\n"}, {"translate": "Ride a Camel Husk with a Parched still riding it for 30 seconds", "color": "#63BDD7"}, {"text": "\n\n"}, {"translate": "Monsters", "color": "gray", "italic": true}]}}