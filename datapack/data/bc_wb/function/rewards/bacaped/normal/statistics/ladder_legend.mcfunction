execute in minecraft:overworld run worldborder add 4.5 73
execute in minecraft:the_nether run worldborder add 4.5 73
execute in minecraft:the_end run worldborder add 4.5 73
scoreboard players set bacaped:statistics/ladder_legend wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 73t
