execute in minecraft:overworld run worldborder add 22.0 137
execute in minecraft:the_nether run worldborder add 22.0 137
execute in minecraft:the_end run worldborder add 22.0 137
scoreboard players set blazeandcave:animal/nest_quick wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 137t
