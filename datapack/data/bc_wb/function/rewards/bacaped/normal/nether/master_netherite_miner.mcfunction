execute in minecraft:overworld run worldborder add 275.0 378
execute in minecraft:the_nether run worldborder add 275.0 378
execute in minecraft:the_end run worldborder add 275.0 378
scoreboard players set blazeandcave:nether/master_netherite_miner wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 378t
