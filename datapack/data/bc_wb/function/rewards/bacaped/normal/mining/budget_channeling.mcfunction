...
scoreboard players set blazeandcave:mining/budget_channeling wb 1
scoreboard players set is_wb_run wb 0
schedule function bc_wb:untask 15t
tellraw @a {"text": " +0.05 Blocks", "color": "#B2FFEE", "hover_event": {"action": "show_text", "value": [{"translate": "Budget Channeling", "color": "green"}, {"text": "\n"}, {"translate": "Craft a Lightning Rod using Copper Ingots", "color": "#49DB49"}, {"text": "\n\n"}, {"translate": "Mining", "color": "gray", "italic": true}]}}